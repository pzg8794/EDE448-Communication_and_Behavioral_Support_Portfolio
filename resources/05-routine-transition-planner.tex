...
\begin{tabularx}{\textwidth}{>{\bfseries\RaggedRight\arraybackslash}p{1.10in} >{\RaggedRight\arraybackslash}p{2.46in} >{\RaggedRight\arraybackslash}X}
\rowcolor{MidTeal}
...
\sourcebox{\scriptsize Personalized souvenir archive \citep{campEvidence2026}; communicative competence \citep{jorgensen2018competence}; first-hand perspectives \citep{gardner2017firsthand}.}