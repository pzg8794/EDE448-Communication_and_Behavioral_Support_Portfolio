\resourceheading{2}{Many Ways to Be a Good Classmate}{Autism inclusion, peer culture \& social-emotional learning}{Teachers, experts \& families}{Module 1 taught Kit for Kids lesson and a documented Grade 2 technology routine}

\vspace{-0.5cm}
\toolsection{What This Resource Is}

This is a ten-minute peer-education lesson that turns ``be kind'' into four observable actions: \textsc{invite, wait, ask, and respect}. It draws on the Organization for Autism Research (OAR) Kit for Kids, the \textit{What's Up with Nick?} booklet, and grade-banded friendship tips \citep{oar2026kit,oar2026nick,oar2026tips}. The lesson normalizes different ways of communicating, learning, moving, regulating, and participating. The strategy supports social-emotional learning and behavior because peer culture can either reduce or magnify access barriers. Students need language to help them without taking over, waiting without rushing, offering space without exclusion, and accepting communication through speech, writing, pictures, AAC, gesture, movement, or silence. During camp, one youth modeled these actions naturally. While another youth needed time and space, he continued working, stayed calm, took initiative when invited, and gave his peer room without excluding him. When the other youth was ready to return, he welcomed him back into the shared activity. He supported participation without taking over or making the moment about his peer's behavior \citep{campEvidence2026}.
...
\rowcolor{SoftGray}
2--4 min & Teach &
Introduce the four actions below with one example and nonexample each. \\
...
\adaptationbox{Ten minutes introduces shared language but can't represent the full range of autistic experience. Pair OAR's educator material with autistic-authored perspectives when developmentally appropriate, adapt examples to age and culture, and monitor whether peers begin to police difference under the banner of helping. Adult redesign remains necessary; peer kindness can't compensate for inaccessible schedules, noise, tools, or instruction.}
...
During camp, one youth continued working while his peer needed time and space, took initiative when invited, and allowed the activity to continue without making his classmate's behavior the focus. When his peer was ready to return, he welcomed him back into the investigation; a concrete example of \textit{invite, wait, and respect} in practice.}
