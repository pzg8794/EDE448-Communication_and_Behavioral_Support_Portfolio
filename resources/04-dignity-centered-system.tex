...
>{\RaggedRight\arraybackslash}p{2.20in}
...
Emotional awareness, joy, discomfort, sensory access, pacing, relationships, and task fit without guessing \\
...
minimum height=0.15in, align=center, font=\tiny, inner sep=1pt},
...
\begin{tabularx}{\textwidth}{
>{\bfseries\RaggedRight\arraybackslash}p{2.0in}
>{\RaggedRight\arraybackslash}X}
...
The camp recap kept the week's activities visible while youth reflected through \textit{I did}, \textit{I learned}, and \textit{I liked}. A learner could point, speak, or use the visual. The memo is therefore one communication route.\par
\end{minipage}
\hfill
\begin{minipage}[c]{0.49\textwidth}
{
\adaptationbox{A camera can create performance pressure or surveillance. Never infer private emotion from appearance, fluency, silence, or refusal. Do not post, send, or retain a memo beyond the agreed audience and purpose. Provide captioning, translation, AAC access, processing time, and a private or asynchronous option. Day 5 had photographs and a same-session transcript; this evidence system names that gap.}
}
