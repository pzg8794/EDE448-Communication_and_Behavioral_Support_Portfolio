...
The 30-second memo was used as an exit ticket. During the Invisible Invaders camp, youth were invited on camera after an activity to explain in their own words what they did, how they felt about it, what they learned or confirmed, and what they wanted to investigate next. The Field Friday memo, a 43-second video, de-identified a youth describing the sand-sampling work, identifying it as hands-on, saying they liked it, distinguishing new learning from something confirmed, and connecting the activity to a larger exposure question \citep{campEvidence2026}. This is a communication support because the learner, not an adult behavior rating, authors the first account of the activity. It also supports social-emotional learning by giving students a routine for recognizing how an experience affected them, naming what helped or did not help, and communicating what they want next. Preferences, confusion, sensory responses, questions, and change requests can become visible before adults reduce them to engagement, compliance, or disruption. The memo gives us, the next teacher, family member, or collaborator evidence for redesign.
...
The surviving Field Friday record includes a 43-second memo; its value is not the recording itself but whether the student's reflection---including emotional experience---can alter the next opportunity.}

\end{center}

\reflectionbox{\textbf{Artifact proof and SEL connection:} the Field Friday video index preserves 18 original recordings and de-identified transcripts. The memo clip began at 1:02:32 p.m. and lasted 43 seconds; adjacent clips preserve another youth's investigation question and a sampling-site hypothesis. More importantly, the memo preserved the learner's own account of what they did, how they experienced it, what they understood, and what they wanted to pursue next. That makes emotional learning consequential: recognizing and communicating a feeling or preference can become evidence for changing the next activity. Planning is not used as proof of implementation; the video/transcript record documents the routine, while later reflection documents interpretation.}
