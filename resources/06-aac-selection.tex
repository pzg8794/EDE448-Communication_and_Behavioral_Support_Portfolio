...
{\centering
The camp model functioned as a communication support because students could point to, revise, and explain ideas through a visible pathway rather than relying on speech alone. The student-authored \textit{Before / During / After} panels remain visible, while the added prompts clarify what a learner can do, what partners should notice, and how partners can respond without replacing the learner's message.\par
}

{\centering
This makes the visual relevant to AAC: it supports commenting, questioning, revising, and action-planning through multiple response routes.\par
}
\end{minipage}
\end{center}
