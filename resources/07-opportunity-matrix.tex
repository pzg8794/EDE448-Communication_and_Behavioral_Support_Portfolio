...
\rowcolor{SoftGray}
Families &
A concrete account of what youth did, communicated, questioned, learned, disliked, or wanted to continue &
...
The recaps changed how camp events were interpreted, not simply how they were displayed. Day 2 records the racket game as a movement reset and relationship route rather than lost instructional time. Day 3 keeps ``point, tell, show, partner, pass + return'' available across the recap so remembering the day does not depend on one communication mode. Day 4 records a sand check as not completed rather than filling the gap with an assumed result. The later youth retrospective asks for less rushing, more investigation time, more physical activity, a non-fish route to the same scientific idea, and numbered showcase stations. The evidence therefore changes both the shared story and the design of what should happen next \citep{campEvidence2026}.
