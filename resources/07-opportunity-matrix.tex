...
\parbox{0.94\textwidth}{\centering\tiny
\textbf{Days 1--5 archive:}
...
Youth &
A visible shared memory of the activities, their words and work, model changes, choices, and open questions &
...
Pacing, materials, questions, roles, sensory supports, participation routes, and what to stop or continue \\

Program partners &
Traceable claims, participation routes, schedule decisions, revisions, and explicit evidence limits &
Institutional understanding, resource decisions, and accountability for adult design \\

\rowcolor{SoftGray}
Families &
A concrete account of what youth did, communicated, questioned, learned, disliked, or continued &
Family conversation, continuity across settings, and knowledge that can return to the teaching team \\

\end{tabularx}

\toolsection{Evidence That Changed the Story \& Puzzle Plan and EQUITAS in Practice}

The recaps changed how camp events were interpreted, not simply how they were displayed. Day 2 records the racket game as a movement reset, teamwork, joy, and a route back into participation rather than lost instructional time. Day 3 keeps ``point, tell, show, partner, pass + return'' available across the recap so remembering the day does not depend on one communication mode. Day 4 records a sand check as not completed rather than filling the gap with an assumed result. The later youth retrospective asks for less rushing, more investigation time, more physical activity, a sensory-safe alternative to the fish activity, and numbered showcase stations. The evidence therefore changes both the shared story and the design of what should happen next \citep{campEvidence2026}.

The Puzzle Plan brings student voice together with artifacts, context, scientific evidence, and adult decisions without forcing those sources into one simplified account. EQUITAS asks whose words enter the recap, who appears only as a body in a photograph, whose refusal or uncertainty disappears, and who gets to correct the institutional story. A recap becomes access-to-agency only when youth communication can alter the record, tomorrow's lesson, the team's interpretation, what leaders understand, or what families receive.

\reflectionbox{\textbf{Artifact proof:} Five reviewed recap decks used for Days 1--5 collectively to preserve activities, youth contributions, communication routes, evidence limits, model revisions, and next questions. Day 6 has a clean retrospective transcript but no sixth recap deck. Day 5 has photographs and a same-session transcript but no source video, so its recap explicitly limits what those photographs can establish \citep{campEvidence2026}.}

\adaptationbox{A recap can still privilege the most verbal, photographed, or adult-approved account. Invite correction through speech, AAC, writing, drawing, pointing, shared visuals, home language, partner support, or private review. Preserve disagreement, refusal, uncertainty, and ``not yet.'' Do not circulate identifiable evidence beyond the audience and purpose for which consent was given.}
