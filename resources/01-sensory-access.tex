...
\reflectionbox{\textbf{Practice artifact --- Pine Brook IGNITE sensory walk:} Picture choices, visual steps, movement, and hands-on materials supported access, while Chromebook audio, robot movement, table noise, directions, and cleanup accumulated. One learner joined the blocks activity when a familiar laptop could remain nearby. Removing that unnecessary either-or condition changed participation and created a reason to keep investigating what supported access.}
...
\textbf{\color{DeepNavy}Return to Participation.}
The same principle appeared during camp: after environmental adjustments, reduced pressure, time, space, and questions that helped us find a workable entry point, one youth returned to the investigation and participated with the group.}
