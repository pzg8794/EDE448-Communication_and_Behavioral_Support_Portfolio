\renewcommand{\sourcebox}[1]{%
  \vspace{0.06in}
  \noindent{\small\color{DeepNavy}\textbf{Key sources.} #1}
}
...
\begin{longtable}{>{\RaggedRight\arraybackslash}p{0.80in} >{\RaggedRight\arraybackslash}p{2.15in} >{\RaggedRight\arraybackslash}p{1.70in} >{\RaggedRight\arraybackslash}p{2.12in}}
...
\adaptationbox{Sensory support is individual and can change across activity, time, fatigue, pain, and experience. The goal is to adjust conditions while protecting communication, participation, and belonging.}
