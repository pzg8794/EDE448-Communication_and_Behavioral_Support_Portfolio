...
\vfill
\begin{center}
\restrictedartifactpanel{assets/artifact-previews/cover-showcase-evidence-strip.png}{0.86\textwidth}{1.22in}{Restricted showcase evidence strip omitted in the public build.}%

\vspace{0.04in}
{\scriptsize\color{DeepNavy}\textbf{Implemented evidence at a glance.} A larger visual anchor for the camp communication system represented throughout the portfolio.}
\end{center}
