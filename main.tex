...
\small
My teaching placement taught me to make participation routes visible and treat student action, questions, artifacts, and multimodal responses as evidence. The \textit{Puzzle Plan} carried that learning into camp by connecting lived experience, lesson design, student voice, scientific records, and adult decisions. \textit{EQUITAS} tested whose account survived each layer and whether it changed interpretation, next-day design, institutional understanding, and family communication.
\end{minipage}
...
\begin{longtable}{
  ...
  >{\RaggedRight\arraybackslash}p{2.65in}
}
